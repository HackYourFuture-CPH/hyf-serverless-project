...
export default function Footer() {
  return (
    <div className="w-full bg-indigo-900 flex flex-col md:flex-row">
      ...
      <ul className="w-full md:w-1/4 flex flex-row justify-start md:justify-end p-5 text-white">
        <li className="w-6 mr-5">
          <Link href="https://www.instagram.com/hackyourfuture.dk/">
            <a target="_blank">
        ...
        <li className="w-6 mr-5">
          <Link href="https://www.youtube.com/channel/UCgWEvuTAyg7qbWcq0M8w4EQ">
            <a target="_blank">
              <svg viewBox="0 0 24 24">
                <path
        ...
        <li className="w-6 mr-5">
          <Link href="https://www.facebook.com/hackyourfuturedenmark">
            <a target="_blank">
              <svg viewBox="0 0 24 24">
                <path
        ...
        <li className="w-6 mr-5">
          <Link href="https://twitter.com/HackyourfutureC">
            <a target="_blank">
              <svg viewBox="0 0 24 24">
                <path
